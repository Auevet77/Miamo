...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="fundo">
      <div class="Centro">
        <h1 class="text-luz" style="font-size: 60px">Fale Conosco</h1>
         
        <br />
        <asp:Label runat="server" Text="Nome" AssociatedControlID="txtNome" CssClass="text-luz lead" />
        <asp:TextBox runat="server" ID="txtNome" CssClass="form-control" MaxLength="100" Width="100%"/>
        ...
        <br />
        <asp:Label runat="server" Text="E-mail" AssociatedControlID="txtEmail" CssClass="text-luz lead" />
        <asp:TextBox runat="server" ID="txtEmail" CssClass="form-control" MaxLength="100" Width="100%" />
        ...
        <br />
        <asp:Label runat="server" Text="Telefone" AssociatedControlID="txtTelefone" CssClass="text-luz lead" />
        <asp:TextBox runat="server" ID="txtTelefone" CssClass="form-control phone_with_ddd" MaxLength="100" Width="100%" />
        ...
        <br />
        <asp:Label runat="server" Text="Mensagem" AssociatedControlID="txtMensagem" CssClass="text-luz lead" />
        <asp:TextBox runat="server" ID="txtMensagem" CssClass="form-control" MaxLength="500" Width="100%" TextMode="MultiLine" />
